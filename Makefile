...
emu8085: createdir MainApp.o main.o FileHandler.o Parser.o Instructions.o Assembler.o Helper.o MainFrame.o FileHandler.o Helper.o Disassembler.o
	$(PROJECT) $(BUILD_DIR)/MainApp.o $(MAIN) $(INSTRUCTIONS) $(WX_WIDGET) $(ASSEMBLER) $(MAIN_FRAME) $(FILE_HANDLER) $(HELPER) $(PARSER) $(DISASSEMBLER)
